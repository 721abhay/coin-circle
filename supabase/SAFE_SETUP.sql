...
-- INSERT INTO bank_accounts (user_id, account_holder_name, account_number, ifsc_code, bank_name, branch_name, is_primary)
-- VALUES (auth.uid(), 'John Doe', '1234567890', 'SBIN0001234', 'State Bank of India', 'Main Branch', true);

-- Set primary account:
-- SELECT set_primary_bank_account('account-uuid-here', auth.uid());
